...
app.MapPost("/clientes/", async (Clientes clientes, TodoContext db) =>
{
...
app.MapGet("/clientes/{id:int}", (int id, TodoContext db) =>
{
...
app.MapGet("/ListClientes/", (TodoContext db) =>
{
...
app.MapGet("/ListCiudades/", (TodoContext db) =>
{
...
app.MapPut("/clientes/{id:int}", async (int id, Clientes inputTodo, TodoContext db) =>
{
...
app.MapDelete("/clientes/{id}", async (int id, TodoContext db) =>
{
...
app.MapPost("/ciudades/", async (Ciudades ciudades, TodoContext db) =>
{
...
app.MapGet("/ciudades/{id:int}", (int id, TodoContext db) =>
{
...
app.MapPut("/ciudades/{id:int}", async (int id, Ciudades inputTodo, TodoContext db) =>
{
...
app.MapDelete("/ciudades/{id}", async (int id, TodoContext db) =>
{
